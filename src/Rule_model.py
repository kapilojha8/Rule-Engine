...
class Rule:
    def __init__(self, ID, Rule_header, Rule_value, Rule_operator, Rule_order, Is_Nested, Nested_Rule, Rule_parent,logical_operator="and", Flow_for_True=False, Flow_for_False=False, Terminate=False):
        self.ID = ID
        ...
        self.Flow_for_True = True
        self.Flow_for_False = True
        self.Terminate = True
    ...
    def evaluate(self, data):
        ...
        print('Header ',self.Rule_header ,'  Obtained Result :',result)
        return result
